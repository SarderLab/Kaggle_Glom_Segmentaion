...
def get_model_lists(config):
    ...
    # # Write keys and shapes of model parameters to the file
...
def mask2json(mask):
    ...
    polygons = [[[int(point[1]), int(point[0])] for point in object] for object in contours]
    # save as json
